...
""" TESTING IF the inverted index mapping UTM points for each location
    to the associated location correctly retrieves those manually
    verified location when indexed by random points chosen

    COMPARING WITH the known 2 points manually selected
"""
